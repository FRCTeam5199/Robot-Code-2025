...
public class AkLogger {
  ...
  private static final AkReceiverThread receiverThread = new AkReceiverThread(receiverQueue);
  ...
  public static void setReplaySource(LogReplaySource replaySource) {
    if (!running) {
      AkLogger.replaySource = replaySource;
    }
  }
  ...
  public static void start() {
    if (!running) {
      ...
      RobotController.setTimeSource(AkLogger::getTimestamp);

...
public Robot() {
    // TODO: Support the use of Constants, such as those shown below for build metadata,
    // and robot execution mode.
    ...
    // }
        ...
        // TESTING - TESTING: Delete this code when the above changes are finalized.
        Logger.recordOutput("TESTING", "Testing simulation logging...");
        Logger.addDataReceiver(new NT4Publisher());
